...
public class CategoryKeeper {
    ...
    private CategoryKeeper(){
      ...
      mCategories.add(new FilterItem("Coffee Shop", R.drawable.ic_local_cafe_grey_48dp, false, R.drawable.ic_local_cafe_blue_48dp));
      mCategories.add(new FilterItem("Food", R.drawable.ic_local_dining_grey_48dp, false, R.drawable.ic_local_dining_blue_48dp));
      mCategories.add(new FilterItem("Hotel", R.drawable.ic_local_hotel_grey_48dp, false, R.drawable.ic_local_hotel_blue_48dp));
      mCategories.add(new FilterItem("Pizza", R.drawable.ic_local_pizza_gray_48dp, true, R.drawable.ic_local_pizza_blue_48dp));
    }
